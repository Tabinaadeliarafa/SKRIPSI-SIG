...
function AdminViz() {
  ...
  const data = KECAMATAN.map((k) => ({ name: k.nama, banjir: k.banjir, longsor: k.longsor, gempa: k.gempa, total: totalDesa(k) }));
  const totals = [
        ...
        <main className="p-4 lg:p-8 space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Konfigurasi chart dan ekspor laporan dalam beberapa format.</p>
            </div>
